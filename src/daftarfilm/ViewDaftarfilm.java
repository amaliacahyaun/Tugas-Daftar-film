...
public class ViewDaftarfilm extends JFrame{
  //tampilan saja
     JLabel lFilm= new JLabel("DAFTAR FILM");
   ...
   public ViewDaftarfilm(){
       ...
       /*btnRefershPanel.addActionListener(new ActionListener(){
        public void actionPerformed(ActionEvent e){
            tfID.setText(null);
            tfJudul.setText(null);
            tfTipe.setText(null);
            tfEpisode.setText(null);
